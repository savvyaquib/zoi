 ...
 *
 * Section headings in Glorify, red, large, on both cards — the site's one
 * display face; the print's two heading faces are not carried over. Sub-groups under a small red bold label with
      ...
      */}
      <div className="md:grid md:grid-cols-[1fr_11rem] md:gap-x-10">
        <div className="flex items-center justify-between gap-5 md:contents">
          {/* Glorify, like every heading on the site — one display voice. */}
          <h2
            id={`${section.id}-title`}
            className="font-display text-[2.25rem] leading-[1.05] font-medium text-menu-red text-balance md:col-start-1 md:row-start-1 md:text-[2.9rem]"
          >
            {section.title}
          </h2>
          {section.art && (
    ...
    >
      <div className="grid items-center gap-8 md:grid-cols-[11rem_1fr] md:gap-12">
        ...
        <div>
          <h2
            id="closing-title"
            className="font-display text-[2.25rem] leading-[1.05] font-medium text-menu-red text-balance md:text-[2.9rem]"
          >
            {closing.title}
          </h2>
